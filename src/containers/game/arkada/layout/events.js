...
import Winner   from '../../../../../assets/game_screen/arkada/winner.png';
import Loser   	 from '../../../../../assets/game_screen/arkada/loser.png';
import Pause   	 from '../../../../../assets/game_screen/arkada/pause.png';
			...
			<View style={styles.modal}>
				{props.status == 'pause' ? (
					<View style={styles.modal_container}>
						...
						<Text style={styles.text}>Кто мудр, тот и добр.</Text>
